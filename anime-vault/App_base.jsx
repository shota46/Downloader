...
const DEFAULT_DL_API = "http://localhost:4040"; // your download server
        ...
        <main className="main">
          <header className="topbar">
            ...
            <div className="topbar-actions">
              ...
              {page==="files" && <button className="btn primary sm">⟳ 更新</button>}
...
function ZipModal({ files, target, dlBase, onClose, toast }) {
  ...
  async function startZip() {
    ...
    //   method:"POST",
    //   headers:{"Content-Type":"application/json"},
    //   body: JSON.stringify({ files: targetFiles.map(f=>f.name), outputName: zipName })
    // });
